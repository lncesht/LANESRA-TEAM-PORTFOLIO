...
export const Home = () => {
  const teamMembers = [
    ...
    { name: 'Miguel', role: 'Cloud Specialist', skills: ['AWS', 'Azure', 'DevOps', 'Serverless Architecture'], image: '/images/miguelpic.png', facebook: 'https://www.facebook.com/Miguelito01101', github: '#' },
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white p-10">
      ...
      {/* Key Focus Areas */}
      <div className="max-w-4xl w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 my-16 justify-items-center text-center">
        {[
          {
            title: "Mission",
            desc: "To deliver innovative and reliable technology solutions that empower businesses and communities to thrive in the digital era. We are committed to excellence, collaboration, and continuous learning to drive impactful results for our clients.",
          },
          {
            title: "Vision",
            desc: "To be a leading force in the tech industry—pioneering future-ready solutions, nurturing talent, and shaping a more connected, efficient, and sustainable digital world.",
          },
        ].map((area, index) => (
          <motion.div
            key={index}
            className="bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-transform transform hover:scale-105 w-full max-w-md"
            whileHover={{ y: -5 }}
